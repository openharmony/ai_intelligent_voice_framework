 ...
 */
#ifndef HEADSET_WAKEUP_ENGINE_TEST_H
#define HEADSET_WAKEUP_ENGINE_TEST_H
...
class HeadsetWakeupEngineTest : private HeadsetWakeupEngineImpl {
public:
    HeadsetWakeupEngineTest();
    ~HeadsetWakeupEngineTest();
    int32_t InitState();
