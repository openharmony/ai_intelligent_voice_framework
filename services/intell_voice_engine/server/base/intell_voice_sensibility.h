 ...
 */
#ifndef INTELL_VOICE_SENSIBILITY
#define INTELL_VOICE_SENSIBILITY
...
class IntellVoiceSensibility {
public:
    IntellVoiceSensibility() = default;
    static std::string GetDspSensibility(const std::string &sensibility, const std::string &dspFeature,
...
private:
    ...
    static bool IsSupportNodes800(const std::string &dspFeature);
};
}
}
#endif